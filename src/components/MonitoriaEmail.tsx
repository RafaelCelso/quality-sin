...
const MonitoriaEmail: React.FC = () => {
  ...
  }, [formData.cordialidade.nota, formData.linguagem.nota, formData.atencaoPerfil.nota, formData.tempoResposta.nota]);
  ...
  const criterios = [
    { key: 'cordialidade', icon: <Heart className="text-emerald-600" size={24} />, title: 'Cordialidade Composição/Desenvolvimento do e-mail' },
    { key: 'linguagem', icon: <MessageSquare className="text-emerald-600" size={24} />, title: 'Linguagem Redigida (escrita)' },
    { key: 'atencaoPerfil', icon: <User className="text-emerald-600" size={24} />, title: 'Atenção ao perfil do destinatário' },
  ...
  return (
    <div className="flex">
      ...
      <div className="flex-1 p-8 bg-gray-100">
        <h1 className="text-2xl font-bold mb-6">Monitoria de E-mail</h1>
